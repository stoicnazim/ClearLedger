          ...
          <tr>
            <td style="padding:0 36px 36px">
              <div style="background:rgba(107,92,231,0.08);border-radius:12px;padding:24px;text-align:center;border:1px solid rgba(107,92,231,0.15)">
                ...
                <a href="https://a1ttvahfc4.calendesk.net" style="display:inline-block;padding:14px 32px;border-radius:8px;text-decoration:none;background:#6B5CE7;color:white;font-size:14px;font-weight:500">Book a Call</a>
              </div>
            </td>
          </tr>
