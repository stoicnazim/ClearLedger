...
import { TrendingDown, TrendingUp, Sparkles, Activity, ShieldCheck, CheckCircle2, ChevronRight, Layers, FileText } from 'lucide-react'
...
export default function Dashboard({ activeTier, onNavigate, simulationRules }) {
  const { financials, logs, disputes } = useMockDatabase()
